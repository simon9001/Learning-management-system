...
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="simongatungo300@gmail.com")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default="0757568845")
EMAIL_FROM_ADDRESS = config("EMAIL_FROM_ADDRESS", default="simongatungo300@gmail.com")
